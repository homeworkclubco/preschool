...
describe('Dropdown Component', () => {
    ...
    `;
        ...
        await customElements.whenDefined('hc-dropdown');
    ...
    it('should dispatch hc-dropdown-open event when opened', async () => {
        const dropdown = document.querySelector('hc-dropdown');
        const trigger = document.getElementById('trigger-btn');
    ...
    it('should dispatch hc-dropdown-close event when closed', async () => {
        const dropdown = document.querySelector('hc-dropdown');
        const trigger = document.getElementById('trigger-btn');
